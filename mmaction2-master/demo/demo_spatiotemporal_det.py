...
def parse_args():
    ...
    parser.add_argument('--video', default='demo_video/test.mp4',help='video file/url')#改
    parser.add_argument('--out-filename',default='demo_video/out_test.mp4',help='output filename')#改
    parser.add_argument(
        '--config',
        default=('/root/autodl-tmp/mmaction2-master/work_dirs/ava/slowfast_kinetics_pretrained_r50_4x16x1_20e_ava_rgb_custom/my_slowfast_kinetics_pretrained_r50_4x16x1_20e_ava_rgb_custom_classes.py'),
        help='spatio temporal detection config file path')
    parser.add_argument(
        '--checkpoint',#改
        default=('/root/autodl-tmp/mmaction2-master/work_dirs/ava/slowfast_kinetics_pretrained_r50_4x16x1_20e_ava_rgb_custom/epoch_40.pth'),
    ...
    parser.add_argument(
        ...
        default=('http://download.openmmlab.com/mmdetection/v2.0/faster_rcnn/'
                 ...
                 'bbox_mAP-0.384_20200504_210434-a5d8aa15.pth'),#人的检测模型
    ...
    parser.add_argument(
        '--label-map',
        default='data/ava/annotations/labelmap.txt',#改，动作类别
        help='label map file')
    parser.add_argument(
