...
def parse_args():
    ...
    subparsers = parser.add_subparsers("/root/autodl-tmp/mmaction2-master/work_dirs/ava/slowfast_kinetics_pretrained_r50_4x16x1_20e_ava_rgb_custom/20241214_183126.log.json",dest='task', help='task parser')
